...
All these components were done by Charles Alba
...
```{r}
compare<-MSE_GHS-MSE_act #our model is better
```
...
```{r}
g= ggplot(timputed_data, aes(idv, log(lambda), label=location))
g + geom_jitter()+geom_text(color="green4")+labs(x= "individualism index", y = "log(lambda)")+ geom_smooth(method = "lm")
```

```{r}
g= ggplot(timputed_data, aes(pdi, log(lambda), label=location))

g + geom_jitter()+geom_text(color="green4")+labs(x= "power distance index", y = "log(lambda)")+ geom_smooth(method = "lm")
```

```{r}
g= ggplot(timputed_data, aes(mas, log(lambda), label=location))

g + geom_jitter()+geom_text(color="green4")+labs(x= "masculinity index", y = "log(lambda)")+ geom_smooth(method = "lm")
```


```{r}
g= ggplot(timputed_data, aes(uai, log(lambda), label=location))

g + geom_jitter()+geom_text(color="green4")+labs(x= "uncertainty avoidance index", y = "log(lambda)")+ geom_smooth(method = "lm")
```


```{r}
g= ggplot(timputed_data, aes(ltowvs, log(lambda), label=location))

g + geom_jitter()+geom_text(color="green4")+labs(x= "long-term orientation index", y = "log(lambda)")+ geom_smooth(method = "lm")
```


```{r}
g= ggplot(timputed_data, aes(ivr, log(lambda), label=location))

g + geom_jitter()+geom_text(color="red3")+labs(x= "indulgence index", y = "log(lambda))")+ geom_smooth(method = "lm")
```
